...
void CPolygon::InitEX(ShaderResources* sr)
{
	...
	// 要素1
	// 頂点の位置
	vertexList[0].pos.x = -0.5f;
	vertexList[0].pos.y = -0.5f;
	vertexList[0].pos.z = 0.0f;
	// 頂点の色
	vertexList[0].col.x = 0.0f;
	vertexList[0].col.y = 1.0f;
	vertexList[0].col.z = 0.0f;
	vertexList[0].col.w = 1.0f;
	// uv
	vertexList[0].uv.x = 0.0f;
	vertexList[0].uv.y = 1.0f;
	// normal
	vertexList[0].normal.x = 0.0f;
	vertexList[0].normal.y = 0.0f;
	vertexList[0].normal.z = 1.0f;

	// 要素2
	// 頂点の位置
	vertexList[1].pos.x = -0.5f;
	vertexList[1].pos.y = 0.5f;
	vertexList[1].pos.z = 0.0f;
	// 頂点の色
	vertexList[1].col.x = 1.0f;
	vertexList[1].col.y = 0.0f;
	vertexList[1].col.z = 0.0f;
	vertexList[1].col.w = 1.0f;
	// uv
	vertexList[1].uv.x = 0.0f;
	vertexList[1].uv.y = 1.0f;
	// normal
	vertexList[1].normal.x = 0.0f;
	vertexList[1].normal.y = 0.0f;
	vertexList[1].normal.z = 1.0f;

	// 要素3
	// 頂点の位置
	vertexList[2].pos.x = 0.5f;
	vertexList[2].pos.y = 0.5f;
	vertexList[2].pos.z = 0.0f;
	// 頂点の色
	vertexList[2].col.x = 1.0f;
	vertexList[2].col.y = 1.0f;
	vertexList[2].col.z = 0.0f;
	vertexList[2].col.w = 1.0f;
	// uv
	vertexList[2].uv.x = 0.0f;
	vertexList[2].uv.y = 1.0f;
	// normal
	vertexList[2].normal.x = 0.0f;
	vertexList[2].normal.y = 0.0f;
	vertexList[2].normal.z = 1.0f;

	// 要素4
	// 頂点の位置
	vertexList[3].pos.x = 0.5f;
	vertexList[3].pos.y = -0.5f;
	vertexList[3].pos.z = 0.0f;
	// 頂点の色
	vertexList[3].col.x = 1.0f;
	vertexList[3].col.y = 0.0f;
	vertexList[3].col.z = 1.0f;
	vertexList[3].col.w = 1.0f;
	// uv
	vertexList[3].uv.x = 0.0f;
	vertexList[3].uv.y = 1.0f;
	// normal
	vertexList[3].normal.x = 0.0f;
	vertexList[3].normal.y = 0.0f;
	vertexList[3].normal.z = 1.0f;
